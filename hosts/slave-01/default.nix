# Slave Node Configuration Template
# This configuration is used for x86 slave nodes
...

{
  ...
  networking = {
    hostName = "slave-01";
    hostId = "2b83af6d";  # Required for ZFS (8 random hex characters)
  ...
  system.autoUpgrade = {
    enable = true;
    flake = "github:KdogDevs/home_lab#slave-01";
    flags = [
      "--update-input"
      "nixpkgs"
      "--commit-lock-file"
